...
func TestPretty(t *testing.T) {
	...
	cases := []struct {
		...
		val: (*Tmarshaler)(nil),
		exp: `"<panic: value method github.com/ffromani/formatr.Tmarshaler.MarshalLog called using nil *Tmarshaler pointer>"`,
	}, {
		...
		val: (*Tstringer)(nil),
		exp: `"<panic: value method github.com/ffromani/formatr.Tstringer.String called using nil *Tstringer pointer>"`,
	}, {
		...
		val: (*Terror)(nil),
		exp: `"<panic: value method github.com/ffromani/formatr.Terror.Error called using nil *Terror pointer>"`,
	}, {
